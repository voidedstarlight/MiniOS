...
class Window(QMainWindow):
	...
	def __init__(self):
		...
		self.newTab(QUrl("https://home.voidedstarlight.repl.co/"), "New Tab")
		self.show()
	...
	def newTab(self, url = None, label = "New Tab"):
		if url is None: url = QUrl("https://home.voidedstarlight.repl.co/")
	...
	def updateURLBox(self, url, engine = None):
		...
		if not url.toString == "":
			...
			self.url_bar.setText("") if url.toString().lower() == "https://home.voidedstarlight.repl.co/" else self.url_bar.setText(url.toString())
