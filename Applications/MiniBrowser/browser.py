...
Mini Browser
Web browser made using Python 3 and PyQt for the MiniOS project: https://github.com/voidedstarlight/MiniOS
"""
...
class Browser(QMainWindow):
	...
	def __init__(self) -> None:
		...
		self.tabs.tabBarDoubleClicked.connect(lambda: self.newTab(url = QUrl("https://home.voidedstarlight.repl.co/")))
		...
		self.newTab(url = QUrl("https://home.voidedstarlight.repl.co/"))  # Add default tab
	...
	def newTab(self, url = QUrl("https://home.voidedstarlight.repl.co/"), label = "New Tab") -> None:
		"""Create a new tab"""
	...
	def toHome(self) -> None:
		"""Go to 'https://home.voidedstarlight.repl.co/'"""
		self.tabs.currentWidget().setUrl(QUrl("https://home.voidedstarlight.repl.co/"))
	...
	def toURL(self) -> None:
		...
		if url in ["browser://home", "browser:home"]: self.tabs.currentWidget().setUrl("https://home.voidedstarlight.repl.co/")
		else:
