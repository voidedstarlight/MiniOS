...
class Window(QMainWindow):
	...
	def __init__(self, parent = None) -> None:
		...
		self.clock.setUrl(QUrl(f"https://home.voidedstarlight.repl.co/clock.html?background_color={returnBackgroundProperties()['background-color-2'][1:]}&text_color={returnBackgroundProperties()['text-color'][1:]}&font_size={returnProperties()['font-size']}px&font_family={returnProperties()['font-family']}"))
	...
	def updateElements(self) -> None:
		...
		self.clock.setUrl(QUrl(
			f"https://home.voidedstarlight.repl.co/clock.html?background_color={returnBackgroundProperties()['background-color-2'][1:]}&text_color={returnBackgroundProperties()['text-color'][1:]}&font_size={returnProperties()['font-size']}px&font_family={returnProperties()['font-family']}"))
