...
def getFileIcon(file_extension: str, file_type: str) -> QIcon:
	...
	elif file_extension == "png": return QIcon("System/images/file_icons/png.png")
	elif file_extension == "jpg": return QIcon("System/images/file_icons/jpg.png")
	elif file_extension == "gif": return QIcon("System/images/file_icons/gif.png")
